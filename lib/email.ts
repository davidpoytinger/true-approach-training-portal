...
function sessionButton(sessionUrl: string) {
  return `<table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;"><tr><td align="center" style="padding-top:20px;padding-bottom:20px;"><table cellpadding="0" cellspacing="0" border="0"><tr><td bgcolor="#0f5138" style="background-color:#0f5138;border-radius:6px;"><a href="${sessionUrl}" style="display:inline-block;padding-top:15px;padding-right:34px;padding-bottom:15px;padding-left:34px;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;color:#ffffff;text-decoration:none;font-weight:bold;">Review Session</a></td></tr></table></td></tr></table>`;
}
